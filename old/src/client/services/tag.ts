...
export const useAddTagGroup = () => {
  return useMutation(
    (data: Omit<TagGroupStorage, 'createUserId' | 'id'>) => {
...
export const useUpdateTagGroup = () => {
  return useMutation(
    (data: Omit<TagGroupStorage, 'createUserId'>) => {
