  ...
  (function (h) {
    ...
    if (!t) {
      ...
      ((i = function () {
        ...
        ((l.innerHTML = h._iconfont_svg_string_),
          (l = l.getElementsByTagName('svg')[0]) &&
            ...
            (l = l),
            (t = document.body).firstChild ? o(l, t.firstChild) : t.appendChild(l)));
      }),
        document.addEventListener
          ...
          : document.attachEvent &&
            ...
            (F.onreadystatechange = function () {
              'complete' == F.readyState && ((F.onreadystatechange = null), d());
            })));
    }
    function d() {
      a || ((a = !0), e());
