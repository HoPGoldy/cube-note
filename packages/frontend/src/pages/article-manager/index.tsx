...
import { useQueryArticleTree, useUpdateArticle } from "@/services/article";
...
const ArticleManager: FC = () => {
  ...
  // 获取左下角菜单树
  const { data: articleTree, isLoading: isLoadingTree } =
    useQueryArticleTree(currentRootArticleId);
      ...
      <PageContent>
        <div className="box-border p-2 flex flex-col flex-nowrap h-full">
          <div className="flex-grow overflow-y-auto overflow-x-hidden">
            ...
            <Spin spinning={updatingArticle}>{renderContent()}</Spin>
